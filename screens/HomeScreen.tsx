...
export default function HomeScreen() {
  ...
  const [teachers, setTeachers] = useState<Array<Teacher>>(teacherData);
  const [institutions, setInstitutions] =
    useState<Array<Institution>>(institutionData);
  const [selectedSubject, setSelectedSubject] = useState<string>();
  const [teachersFilterVisible, setTeachersFilterVisible] =
   ...
   */
  const filterTeachersBySubject = (subject: string) => {
